...
// images
import blewbo from "/public/images/slider/blewbo.png";
import duronn from "/public/images/slider/durron.png";
import korsgy from "/public/images/slider/korsgy.png";
import knt from "/public/images/slider/ktn.png";
import lingo from "/public/images/slider/lingo.png";
import ogc from "/public/images/slider/ogc.png";
...
const PartnerLogoSlider = () => {
  ...
  return (
    <div className="p-4 md:p-8 px-12 ">
      ...
      <Slider {...setting}>
        {images.map((i, index) => (
          <a href={i.url} target="_blank" rel="noreferrer" key={index}>
            <span className="">
              {" "}
              <Image
                src={i.logo}
                alt={i.url}
                className="w-[7rem] md:w-[8rem]"
              />
            </span>
          </a>
        ))}
